using Godot;
using System;
<<<<<<<< HEAD:scripts/Personaje/MaquinasDeEstados/Movimiento/States/DoubleJumpMovementState.cs
using Faeterna.Scripts.Personaje.MaquinasDeEstados;
using PlayerType = Faeterna.Scripts.Personaje.Lira;
========
using PlayerType = Faeterna.scripts.Personaje.Lira;
>>>>>>>> origin/Particulas:scripts/Maquinas de estados/Movimiento/Estados/DoubleJumpMovementState.cs
