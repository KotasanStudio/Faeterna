...
namespace Faeterna.scripts.Menus
{
    ...
    {
        /// <summary>Ruta predeterminada a la escena del juego cuando se inicia un nuevo juego o no hay partida guardada (DevRoom).</summary>
        private const string DefaultGameScenePath = "res://scenes/Maps/DevRoom.tscn";

        /// <summary>Ruta a la textura que indica que existe una partida guardada en un espacio (botón "Continue").</summary>
